...
export abstract class ColumnDirective {
  ...
  updateSize(size: string | number | undefined | null) {
    if (this.size) {
      this.renderer.removeClass(this.elementRef.nativeElement, `fafn-${this.className}-${this.size}`);
    } else {
      this.renderer.removeClass(this.elementRef.nativeElement, `fafn-${this.className}`);
    }
    ...
    if (Number.isInteger(value) && value > 0) {
      ...
      this.size = undefined;
      this.renderer.addClass(this.elementRef.nativeElement, `fafn-${this.className}`);
    }
  }
  ...
  updateOffset(offset: string | number | undefined | null) {
    if (this.offset) {
      this.renderer.removeClass(this.elementRef.nativeElement, `fafn-${this.className}-offset-${this.offset}`);
    } else {
      this.renderer.removeClass(this.elementRef.nativeElement, `fafn-${this.className}-offset`);
    }
    ...
    if (Number.isInteger(value) && value > 0) {
      ...
      this.renderer.addClass(this.elementRef.nativeElement, `fafn-${this.className}-offset`);
    }
  }
}
