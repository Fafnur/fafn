...
export const SYNC_STORAGE_KEY = new InjectionToken<string>('SYNC_STORAGE_KEY');

/**
 * Storage key default
 * @publicApi
 */
export const ASYNC_STORAGE_KEY_DEFAULT = 'FAFN_ASYNC_STORAGE';
export const SYNC_STORAGE_KEY_DEFAULT = 'FAFN_SYNC_STORAGE';
 ...
 *
 * @Injectable()
 * export class LocalStorageSync extends SyncStorage {
 *   constructor() {
 ...
 * ```
 */
export abstract class StorageNative implements Storage {
  /**
 ...
 * ```
 */
export abstract class StorageAsync<S> {
  /**
   * Current state
   */
...
/**
 * StorageSync for Local storage and Session storage
 * @publicApi
 * ```
 */
export abstract class StorageSync<S> {
  /**
   * Current state
   */
